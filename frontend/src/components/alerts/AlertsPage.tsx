...
const getStatusColor = (status: string) => {
  switch (status) {
    ...
    case 'critical': return 'text-muted'
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={cn(
              'btn-control',
              isMonitoringEnabled ? 'bg-primary/20 border-primary/30 text-primary' : ''
            )}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="control-card p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted">Alert Totali</p>
        ...
        <div className="control-card p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted">Non Letti</p>
              <p className="text-2xl font-bold text-primary">{alertStats.unread}</p>
            </div>
        ...
        <div className="control-card p-6 border-muted/30">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-muted">{alertStats.critical}</p>
            </div>
            ...
            <div className="space-y-4">
              {isLoadingLogs ? (
                <div className="text-center py-8 text-muted">
                  <Bell className="h-12 w-12 mx-auto mb-4 text-muted animate-pulse" />
                ...
                filteredAlerts.map((alert) => (
                  <div
                    ...
                    className={cn(
                      ...
                      !alert.isRead ? 'bg-card/50 border-border' : 'bg-card/30 border-border',
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-3">
                            ...
                            {alert.count > 1 && (
                              <span className="px-2 py-1 bg-card text-muted rounded text-xs">
                                x{alert.count}
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex items-center justify-between text-xs">
                          <div className="flex items-center gap-3">
                            <span className="text-muted">Sorgente: {alert.source}</span>
                            <span className="text-primary capitalize">{alert.category}</span>
                          </div>
              ...
              <div key={metric.id} className="control-card p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="text-right">
                    {metric.trend === 'up' && <TrendingUp className="h-4 w-4 text-muted" />}
                    {metric.trend === 'down' && <TrendingDown className="h-4 w-4 text-primary" />}
                    {metric.trend === 'stable' && <span className="text-muted text-xs">—</span>}
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className={cn(
                    'font-medium',
                    metric.change > 0 ? 'text-muted' : 'text-primary'
                  )}>
                  ...
                  <div className="w-full bg-card rounded-full h-1.5">
                    <div 
                      className={cn(
                        ...
                        metric.status === 'warning' ? 'bg-primary' : 'bg-muted'
                      )}
          ...
          <div className="control-card p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h4 className="text-foreground font-medium mb-1">Scheduler Service</h4>
                <p className={cn(
                  'text-sm',
                  schedulerStatus?.scheduler?.isRunning ? 'text-primary' : 'text-muted'
                )}>
              ...
              <div className="text-center">
                ...
                <h4 className="text-foreground font-medium mb-1">Database</h4>
                <p className="text-primary text-sm">Healthy</p>
                <p className="text-xs text-muted">
              ...
              <div className="text-center">
                ...
                <h4 className="text-foreground font-medium mb-1">Tenants</h4>
