    ...
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white/10 backdrop-blur-lg mb-4">
              <div className="animated-gradient w-14 h-14 rounded-xl flex items-center justify-center">
                <span className="text-foreground font-bold text-2xl">PP</span>
              </div>
            </div>
          ...
          {/* Form card */}
          <div className="premium-card rounded-2xl p-8 backdrop-blur-2xl bg-white/10 border border-white/20">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={cn(
                      ...
                      'text-foreground placeholder-white/50',
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-foreground/70">Ricordami</span>
                </label>
                <button
                  type="button"
            ...
            <div className="mt-6 p-4 rounded-lg bg-white/5 border border-white/10">
              <p className="text-xs text-foreground/60 mb-2">Credenziali Demo:</p>
